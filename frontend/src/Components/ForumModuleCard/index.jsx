...
const Index = ({ id, setModule }) => {
    ...
    return (
        <div className='flex flex-col justify-between items-center h-[460px] w-[460px] bg-[#DEF1DD] rounded-[30px] p-8'>
            ...
            <button className='w-[300px] h-[40px] rounded-[20px] flex justify-center items-center shadow-md hover:scale-105 duration-200 bg-[#91C28D]' onClick={() => { setModule(id) }}>
