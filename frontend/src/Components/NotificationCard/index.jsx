...
const Index = ({ name, date, type, status }) => {
    return (
        <Link className={`w-full h-auto px-6 py-2 border rounded-[10px] flex flex-row gap-3 items-center hover:border-[#91C28D] justify-between ${status === 'unread' ? 'bg-[#DEF1DD] border-[#91C28D]' : 'border-[#DCDCDC]'}`}>
