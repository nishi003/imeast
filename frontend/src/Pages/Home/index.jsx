...
import logo_lg from '../../Components/Assets/logo-xl.png';
...
export const index = () => {
    return (
        <div className='h-screen overflow-y-scroll scroll-snap-y z-10'>
            <section className='w-full h-screen flex flex-col items-center justify-center'>
                <div className='flex flex-row items-baseline gap-4 justify-center mt-[-90px]'>
